export default {
  //登录界面
  auth: {
    loginToLemonAI: "Se connecter à Mighty Agent",
    registerLemonAIAccount: "Créer un compte Mighty Agent",
  ...
  lemon: {
    ...
    preview: {
      title: "L'ordinateur de Mighty Agent",
      openVsCode: "VS Code",
      using: "Mighty Agent utilise",
